...
class Product extends Model
{
    ...
    public static function variantDetailsProductByProId($id){
        $data = DB::table('products')->select('products.id as product_id','productVariantDetails.color_id','productVariantDetails.price','productVariantDetails.discount',
        'productVariantDetails.quantity','colors.name as color_name','colors.color_code','variants.variant_name','productVariant.variant_id',
        'productVariantDetails.id as product_variant_detail_id','productVariantDetails.deleted_at as delete_tails')
