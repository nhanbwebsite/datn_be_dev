...
use App\Models\ShoppingGuideOnline;
use Exception;
...
class ShoppingGuideOnlineController extends Controller
{
    /**
    ...
    {
        try{
            $data= ShoppingGuideOnline::paginate(10);
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $data = ShoppingGuideOnline::create([
     ...
     *
     * @param  \App\Models\ShoppingGuideOnline  $ShoppingGuideOnline
     * @return \Illuminate\Http\Response
     */
    public function show($id)
    {
        try{
            $data = ShoppingGuideOnline::find($id);
