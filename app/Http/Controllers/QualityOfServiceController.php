...
use App\Models\QualityOfService;
use Exception;
...
class QualityOfServiceController extends Controller
{
    /**
    ...
    {
        try{
            $data= QualityOfService::paginate(10);
     ...
     *
     * @param  \App\Models\QualityOfService  $QualityOfService
     * @return \Illuminate\Http\Response
     */
    public function show($id)
    {
        try{
            $data = QualityOfService::find($id);
