...
use App\Models\TradingCondition;
use Exception;
...
class TradingConditionController extends Controller
{
    /**
    ...
    {
        try{
            $data= TradingCondition::paginate(10);
     ...
     *
     * @param  \App\Models\TradingCondition  $TradingCondition
     * @return \Illuminate\Http\Response
     */
    public function show($id)
    {
        try{
            $data = TradingCondition::find($id);
